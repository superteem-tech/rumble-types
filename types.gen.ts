// Rumble API version: 1.15.0
// Generated on: Fri Jan 23 2026 19:01:51 GMT+0800 (Australian Western Standard Time)
...
export type ListOfGroupPostComment = {
    totalItemCount: number;
    items: Array<GroupPostComment>;
};
...
export type CreateGroupPostCommentSettings = {
    content: string;
};

export type UpdateGroupPostCommentSettings = {
    content: string;
    version: number;
};
 ...
 * 2 = TiptapJson
 */
export type RichTextType = 0 | 1 | 2;

export type ListOfGroupPost = {
    totalItemCount: number;
    items: Array<GroupPost>;
};

export type CreateGroupPostSettings = {
    groupId: string;
    title: string;
    subtitle: string | null;
    tags: Array<string> | null;
...
export type UpdateGroupPostSettings = {
    title: string;
    subtitle: string | null;
    tags: Array<string> | null;
    content: unknown;
...
export type ListOfNoteComment = {
    totalItemCount: number;
    items: Array<NoteComment>;
};

export type NoteComment = NoteComment2 & {
    content: unknown;
};

export type NoteComment2 = {
    id: string | null;
    noteId: string | null;
...
export type CreateNoteCommentSettings = {
    content: unknown;
};

export type UpdateNoteCommentSettings = {
    content: unknown;
    version: number;
};

export type ListOfNote = {
    totalItemCount: number;
    items: Array<Note>;
};
...
export type NoteOwnerType = 'Unknown' | 'Group';
...
export type UpdateNoteContentSettings = {
    content: unknown;
    version: number;
};
...
export type ClientOptions = {
    baseUrl: 'https://localhost:44379' | (string & {});
};